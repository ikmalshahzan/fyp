...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Tempahan saya</h4>
    </div>
    <div class="card-body">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Tempahan Masa Lalu</a>
            </li>
        </ul>
                    ...
                    <table id="myTable2" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $sql2 = "SELECT t.id, t.no_kenderaan, t.status as status_t, t.tarikh_masa_tempahan, j.nama_kenderaan, m.jenis_masalah, s.status
                                ...
                                JOIN tbl_status as s
                                ON t.status = s.id
                                WHERE t.status = 3 OR t.status = 4 AND id_user = " . $_SESSION['id'] . "";
